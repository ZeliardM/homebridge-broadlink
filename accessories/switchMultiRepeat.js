...
class SwitchMultiAccessory extends SwitchAccessory {
  ...
  setupServiceManager() {
    ...
    setTimeout(() => {
      log(`\x1b[33m[Warning] \x1b[0m${name}: The "switch-multi-repeat" accessory is now deprecated and shall be removed in the future. Check out the updated "switch" documentation at http://github.com/lprhodes/homebridge-broadlink`);
    }, 1600)
